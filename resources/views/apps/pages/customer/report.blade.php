					...
					<div class="card-block">
						<div>
							<div class="form-body">
								...
								<div class="form-group row">
	                            	<label class="col-md-2 label-control" for="projectinput1">PIN</label>
		                            <div class="col-md-9">
		                            	<span>{{$dataCus->pin}}</span>
		                            </div>
		                        </div>
								<div class="form-group row">
	                            	<label class="col-md-2 label-control" for="projectinput1">User Account</label>
		                            <div class="col-md-9">
		                            	<span>{{$dataCus->user_status}}</span>
		                            </div>
		                        </div>
								<div class="form-group row">
	                            	<label class="col-md-2 label-control" for="projectinput1">User Type</label>
		                            <div class="col-md-9">
		                            	<span>
		                            		@if($dataCus->privilege==0)
		                            			Normal User
		                            		@else
		                            			Staff / Admin
		                            		@endif
